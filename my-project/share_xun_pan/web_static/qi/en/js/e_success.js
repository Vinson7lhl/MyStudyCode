    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if(res.inquiry.is_show_link_info == '0') {
                ...
                // 修改文本
                $_firm_email.text('The user has not disclosed his/her contact information, it is therefore inaccessible.')
            } else {
                // 修改文本
                $_firm_email.text(res.inquiry.pc_email).addClass('valueBlue')
